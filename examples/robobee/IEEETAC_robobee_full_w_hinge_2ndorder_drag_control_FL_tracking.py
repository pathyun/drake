...
from robobee_plant_full_w_hinge_2ndorder_aero import *
...
robobee_plant_aero = RobobeePlantAero(
    ...
    g = g, rw_l= rw_l, bw=bw, m_eq=m_eq, b_eq=b_eq, k_eq=k_eq, H_mag=H_mag, input_max = input_max)
...
def test_harmonic_controller(x, t):
    ...
    # [-pi, pi].
    u = np.zeros(10)
    global g, m, I, r_w, rw_l, bw, xf, Aout, Bout, Mout, T_period, w_freq, radius, ratio_ab, delta_lissajous, ratio_rw, circle_flag, w_resonance, u_sampled, rho, beta_geometry, CL, chordlength_r, chordlength_cr, blade_width, torque_flag
    ...
    if torque_flag==1:
        ...
        mean_stroke_r = 0 #math.pi/15*math.sin(w_resonance*0.1*t);
    ...
    Phi_amp_l = -math.pi/7.0;
    Phi_amp_r = math.pi/7.0;
...
ubar = np.zeros((10,num_iteration)) # Convert to Euler Angle
u = np.zeros((10,num_iteration)) # Convert to Euler Angle
...
# print(u)
filter_length = num_sample_cycle*3
