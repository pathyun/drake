...
# 30 blades
chordlength_r = np.loadtxt('chordlength_list_r_10.txt')
chordlength_cr = np.loadtxt('chordlength_list_cr_10.txt')
chordlength_yLE = np.loadtxt('chordlength_list_yLE_10.txt')
...
rf = np.array([0.05,0.05,0.3])+rw_l*e3
